    ...
    >
      ...
      <View style={styles.View_2_180}>
        <ImageBackground
          ...
          style={styles.ImageBackground_I2_180_2_2}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I2_180_2_6}
        />
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_I2_180_2_10}
        />
      </View>
      ...
      <View style={styles.View_2_183}>
        <Text style={styles.Text_2_183}>9:40</Text>
      </View>
      <View style={styles.View_2_222}>
        <Text style={styles.Text_2_222}>Welcome to the App!</Text>
      </View>
      <View style={styles.View_2_224}>
        <View style={styles.View_I2_224_2_61} />
        <View style={styles.View_I2_224_2_62}>
          <Text style={styles.Text_I2_224_2_62}>Register</Text>
        </View>
      </View>
      <View style={styles.View_2_234}>
        <Text style={styles.Text_2_234}>
          First task is to sign up, then you can check that off your ToDo list
          and feel accomplished
        </Text>
      </View>
      <View style={styles.View_2_249}>
        <Text style={styles.Text_2_249}>Already have an Account? Sign In</Text>
      </View>
      <View style={styles.View_2_239}>
        <View style={styles.View_2_235} />
        <View style={styles.View_2_237}>
          <Text style={styles.Text_2_237}>Enter your email address</Text>
        </View>
      </View>
      <View style={styles.View_2_240}>
        <View style={styles.View_I2_240_2_235} />
        <View style={styles.View_I2_240_2_237}>
          <Text style={styles.Text_I2_240_2_237}>FIrst name</Text>
        </View>
      </View>
      <View style={styles.View_2_243}>
        <View style={styles.View_I2_243_2_235} />
        <View style={styles.View_I2_243_2_237}>
          <Text style={styles.Text_I2_243_2_237}>Last name</Text>
        </View>
      </View>
      <View style={styles.View_2_246}>
        <View style={styles.View_I2_246_2_235} />
        <View style={styles.View_I2_246_2_237}>
          <Text style={styles.Text_I2_246_2_237}>Password</Text>
        </View>
      </View>
    </ScrollView>
  )
